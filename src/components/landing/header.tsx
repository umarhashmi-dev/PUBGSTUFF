...
import { Monitor, Smartphone, Bot, ShoppingCart, User } from 'lucide-react';
            ...
            {user ? (
                 <DropdownMenu>
                    ...
                    <DropdownMenuGroup>
                        ...
                        <DropdownMenuItem asChild><Link href="/my-account/orders">Orders</Link></DropdownMenuItem>
                        <DropdownMenuItem asChild><Link href="/my-account/favorites">Favorites</Link></DropdownMenuItem>
                    </DropdownMenuGroup>
                    <DropdownMenuSeparator />
                    <DropdownMenuItem>
                        Log out
