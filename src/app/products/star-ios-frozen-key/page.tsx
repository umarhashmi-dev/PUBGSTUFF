...
const images = [
    { id: 1, src: 'https://i.postimg.cc/SxKT8Bjm/star-ios-frozen-key.jpg', alt: 'Main product image', aiHint: 'gaming character cinematic' },
...
export default function SingleProductPage() {
    ...
    const handleFavoriteClick = () => {
        ...
        toast({
            ...
            description: `Star iOS Frozen Key has been ${isFavorited ? 'removed from' : 'added to'} your favorites.`,
        });
    };
            ...
            <div className="flex min-h-screen flex-col bg-gray-50">
                ...
                <main className="flex-1 pt-24 md:pt-32">
                    <div className="container mx-auto px-4 py-8">
                        <div className="grid grid-cols-1 lg:grid-cols-[6fr,5fr] gap-8 md:gap-12 max-w-5xl mx-auto">
                            ...
                            <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 font-headline mt-1">Star iOS Frozen Key</h1>
                                        ...
                                        <div className="border border-gray-200 rounded-lg p-4">
                                            <div className="flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <h2 className="text-lg font-bold text-gray-900">Star iOS Frozen Key</h2>
                                                </div>
                                                <div className="flex items-center gap-2">
                                ...
                                <TabsContent value="description" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                                    <div className="prose prose-gray max-w-none space-y-4">
                                        <div className="bg-[#F5EFFF] p-4 rounded-lg">
                                            <p>Star iOS is a premium PUBG Mobile tool designed for players who want to gain a sharp advantage in every match. With a trusted reputation, this product is proven to be safe, secure, and effective.</p>
                                        </div>
                                        
                                        <div className="bg-[#E5D9F2] p-4 rounded-lg">
                                            <h3 className="font-headline font-bold text-xl mb-4">Key Features:</h3>
                                            <ul className="space-y-2 list-disc pl-5">
                                                <li>Players, Bots & Airdrop ESP</li>
                                                <li>HWID Spoofer</li>
                                                <li>Aimbot & Recoil Control</li>
                                                <li>Radar & Item Visuals</li>
                                                <li>24/7 Dedicated Support</li>
                                                <li>Aimbot FOV Value</li>
                                                <li>Draw FOV as Circle</li>
                                            </ul>
                                        </div>

                                        <div className="bg-[#CDC1FF] p-4 rounded-lg">
                                            <h3 className="font-headline font-bold text-xl mb-4">Why Choose Star iOS Frozen Key?</h3>
                                            <p>Unlike ordinary cheats, Star iOS is a professional PUBG Mobile enhancement designed with account safety in mind. It combines Aimbot, ESP visuals, and precision tools with Antiban protection. For players who want to test Star iOS's premium features safely for 1 day, this is the best choice.</p>
                                        </div>
                                    </div>
                                </TabsContent>
                                ...
                                <TabsContent value="faqs" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                                    ...
                                    <Accordion type="single" collapsible className="w-full">
                                        <AccordionItem value="item-1">
                                            <AccordionTrigger>Is Star iOS safe to use on my main account?</AccordionTrigger>
                                            <AccordionContent>
                                     ...
                                     <Table>
                                        <TableHeader>
                                            <TableRow>
                                                ...
                                                <TableHead className="text-center">Star iOS</TableHead>
                        ...
                        <RelatedProducts category="ios" currentProduct="Star iOS Frozen Key" />
                    </div>
                </main>
                <Footer />
            </div>
