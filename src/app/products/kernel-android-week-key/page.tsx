...
const images = [
    { id: 1, src: 'https://i.postimg.cc/NjV8sb9G/Kernel-Android-week-key.jpg', alt: 'Main product image', aiHint: 'gaming character cinematic' },
...
const features = [
    ...
    "ESP (Players, Bots, Airdrops)",
    "Recoil & Aimbot Control",
    "HWID Spoofer",
    "Radar & Visuals",
    ...
    const handleFavoriteClick = () => {
        ...
        if (isProductFavorited) {
            ...
            toast({
                ...
                description: `Kernel Android Week Key has been removed from your favorites.`,
            });
        } else {
            addToFavorites(product);
            toast({
                title: "Added to Favorites",
                description: `Kernel Android Week Key has been added to your favorites.`,
            });
        }
    };
            ...
            <div className="flex min-h-screen flex-col bg-gray-50">
                ...
                <main className="flex-1 pt-24 md:pt-32">
                    <div className="container mx-auto px-4 py-8">
                        <div className="grid grid-cols-1 lg:grid-cols-[6fr,5fr] gap-8 md:gap-12 max-w-5xl mx-auto">
                            ...
                            <div className="bg-white p-4 sm:p-6 rounded-xl border border-gray-200">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 font-headline mt-1">Kernel Android Week Key</h1>
                                        ...
                                        <div className="border border-gray-200 rounded-lg p-4">
                                            <div className="flex justify-between items-center">
                                                <div>
                                                    ...
                                                    <h2 className="text-lg font-bold text-gray-900">Kernel Android Week Key</h2>
                                                </div>
                                                <div className="flex items-center gap-2">
                                ...
                                <TabsContent value="description" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                                    <div className="prose prose-gray max-w-none space-y-4">
                                        <div className="bg-[#F5EFFF] p-4 rounded-lg">
                                            <p>Kernel Root is a premium PUBG Mobile tool designed for players who want to gain a sharp advantage in every match. With a trusted reputation, this product is proven to be safe, secure, and effective.</p>
                                        </div>
                                        ...
                                        <div className="bg-[#CDC1FF] p-4 rounded-lg">
                                            <h3 className="font-headline font-bold text-xl mb-4">Why Choose Kernel Android Week Key?</h3>
                                            <p>Unlike ordinary cheats, Kernel Root is a professional PUBG Mobile enhancement designed with account safety in mind. It combines Aimbot, ESP visuals, and precision tools with Antiban protection. For players who want to test Kernel Root's premium features safely for a week, this is the best choice.</p>
                                        </div>
                                    </div>
                                </TabsContent>
                                ...
                                <TabsContent value="faqs" className="mt-6 bg-white p-6 md:p-8 rounded-xl border border-gray-200">
                                    ...
                                    <Accordion type="single" collapsible className="w-full">
                                        <AccordionItem value="item-1">
                                            <AccordionTrigger>Is Kernel Root safe to use on my main account?</AccordionTrigger>
                                            <AccordionContent>
                                     ...
                                     <Table>
                                        <TableHeader>
                                            <TableRow>
                                                ...
                                                <TableHead className="text-center">Kernel Root</TableHead>
                                        ...
                                        <TableBody>
                                            ...
                                            <TableRow>
                                                <TableCell className="font-medium">Aimbot & Recoil Control</TableCell>
                        ...
                        <RelatedProducts category="android" currentProduct="Kernel Android Week Key" />
