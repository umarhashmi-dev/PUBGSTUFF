...
import { Brush, LayoutDashboard, Server, Zap, HeartHandshake, ArrowRight, Star, Briefcase, Users } from "lucide-react";
...
const stats = [
    { value: "150+", label: "Projects Completed", icon: <Briefcase className="w-8 h-8 text-primary" /> },
    { value: "98%", label: "Client Satisfaction", icon: <Star className="w-8 h-8 text-primary" /> },
    { value: "50+", label: "Happy Clients", icon: <Users className="w-8 h-8 text-primary" /> },
];
            ...
            <div className="container px-4">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="mt-6 text-lg max-w-xl leading-8 text-muted-foreground">
                            We are a passionate team of developers, designers, and digital experts dedicated to providing top-tier services that drive growth and innovation.
                        </p>
                        <div className="mt-10">
            ...
            <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="mt-4 text-lg text-muted-foreground">To empower businesses and individuals with innovative and reliable digital solutions that drive success and foster growth in a connected world.</p>
                        <p className="mt-4 text-lg text-muted-foreground">Our vision is to be a leading provider of comprehensive digital services, recognized for our commitment to quality, customer satisfaction, and technological excellence.</p>
                    </motion.div>
                    <motion.div
                         initial={{ opacity: 0, scale: 0.9 }}
                         ...
                         viewport={{ once: true }}
                    >
                        <div className="relative aspect-video max-w-xl mx-auto rounded-2xl overflow-hidden shadow-xl">
                            <Image 
            ...
            <div className="container">
                ...
                {features.map((feature, index) => (
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <Card className="bg-card hover:bg-card/90 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-lg border-border/10 text-center h-full flex flex-col">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {testimonials.map((testimonial, index) => (
                        <motion.div
                          ...
                          viewport={{ once: true }}
                        >
                            <Card className="bg-secondary/30 flex flex-col p-6 h-full border-border/10">
