      ...
      <main className="flex-1">
        <section className="pt-24 md:pt-32 pb-12 md:pb-20 text-center bg-secondary/50">
          <div className="container">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground md:text-5xl lg:text-6xl font-headline">
              About PUBGSTUFF
            </h1>
        ...
        <section id="team" className="py-12 md:py-24">
            <div className="container">
                <div className="text-center mb-12 md:mb-16">
                    ...
                    <p className="mt-4 text-base sm:text-lg text-muted-foreground">The minds behind the magic.</p>
                </div>
                    ...
                    {teamMembers.map((member) => (
                        <Card key={member.name} className="text-center overflow-hidden transition-shadow duration-300 hover:shadow-xl">
                            <CardContent className="p-6 md:p-8">
                                <div className="flex justify-center items-center h-24 w-24 md:h-32 md:w-32 rounded-full bg-secondary/50 mx-auto mb-6 border-4 border-background shadow-lg">
                                    {member.icon}
                                </div>
                                <h3 className="text-xl sm:text-2xl font-bold font-headline">{member.name}</h3>
        ...
        <section id="mission" className="py-12 md:py-24 bg-secondary/50">
            <div className="container max-w-4xl mx-auto text-center">
                ...
                <div className="mt-10 md:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                    {skills.map((skill) => (
                        <div key={skill.name} className="flex flex-col items-center gap-4 p-4 md:p-6 rounded-lg bg-background shadow-sm">
